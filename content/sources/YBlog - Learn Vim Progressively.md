---
title: "YBlog - Learn Vim Progressively"
created: 2026-04-12
description:
tags:
  - "nivm"
...
![Über leet use vim!](https://yannesposito.com/Scratch/img/blog/Learn-Vim-Progressively/uber_leet_use_vim.jpg)
...
4. Word moves:
	...
	> 1. `W` → go to the start of the following WORD,
	> 2. `E` → go to the end of this WORD.
	> ![Word moves example](https://yannesposito.com/Scratch/img/blog/Learn-Vim-Progressively/word_moves.jpg)
...
### Move on current line: 0 ^ $ g\_ f F t T,;
...
> - `F` and `T` → like `f` and `t` but backward. ![Line moves](https://yannesposito.com/Scratch/img/blog/Learn-Vim-Progressively/line_moves.jpg)
...
![Text objects selection](https://yannesposito.com/Scratch/img/blog/Learn-Vim-Progressively/textobjects.png)
...
![Rectangular blocks](https://yannesposito.com/Scratch/img/blog/Learn-Vim-Progressively/rectangular-blocks.gif)
...
![Completion](https://yannesposito.com/Scratch/img/blog/Learn-Vim-Progressively/completion.gif)
...
![Macros](https://yannesposito.com/Scratch/img/blog/Learn-Vim-Progressively/macros.gif)
...
- `=` → auto indent
![Autoindent](https://yannesposito.com/Scratch/img/blog/Learn-Vim-Progressively/autoindent.gif)
...
- `A`, write text, `ESC`.
![Append to many lines](https://yannesposito.com/Scratch/img/blog/Learn-Vim-Progressively/append-to-many-lines.gif)
...
![Split](https://yannesposito.com/Scratch/img/blog/Learn-Vim-Progressively/split.gif)
...
> If you liked this article, there is a follow up: [*Vim as IDE*](https://yannesposito.com/Scratch/en/blog/Vim-as-IDE/)

[↑ Top ↑](#header)

Published on 2011-08-25

[Follow @yogsototh@ieji.de](https://ieji.de/@yogsototh)
