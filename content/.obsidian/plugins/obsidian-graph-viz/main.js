...
var require_minimatch = __commonJS({
  "node_modules/minimatch/minimatch.js"(exports, module2) {
    ...
    Minimatch.prototype._matchGlobstar = function(file2, pattern, partial, fileIndex, patternIndex) {
      ...
      return !!this._matchGlobStarBodySections(file2, bodySegments, fileIndex, 0, partial, 0, !!fileTailMatch);
    };
    Minimatch.prototype._matchGlobStarBodySections = function(file2, bodySegments, fileIndex, bodyIndex, partial, globStarDepth, sawTail) {
      ...
      while (fileIndex <= after) {
        var m = this._matchOne(file2.slice(0, fileIndex + body.length), body, partial, fileIndex, 0);
        if (m && globStarDepth < this.maxGlobstarRecursion) {
          var sub = this._matchGlobStarBodySections(file2, bodySegments, fileIndex + body.length, bodyIndex + 1, partial, globStarDepth + 1, sawTail);
          if (sub !== false) {
            return sub;
          }
        }
...
var Processors = class {
  ...
  imageProcessor(source, el, _) {
    return __async(this, null, function* () {
      var _a;
      const stringBeforeBrace = ((_a = source.split("{", 1)[0]) == null ? void 0 : _a.trim()) || "";
...
var Suggesters = class extends import_obsidian2.EditorSuggest {
...
// src/main.ts
var GraphvizPlugin = class extends import_obsidian3.Plugin {
  onload() {
    return __async(this, null, function* () {
