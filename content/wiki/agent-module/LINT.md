...
| Check                                      | Flag as             |
| ------------------------------------------ | ------------------- |
| Missing "Formal Definition" section        | `status: stub`      |
| Missing "Explanation" section              | `status: stub`      |
| Missing Visual Explanation diagram         | needs diagram       |
| Missing Semantic Network diagram           | needs diagram       |
| Has math but no Mathematical Formulation   | missing LaTeX       |
| Connections section has fewer than 4 links | thin connections    |
