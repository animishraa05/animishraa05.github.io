...
Auto-created stub for broken link `[[scalability]]` — needs human content.
...
```dot
graph semantic_scalability {
  layout=neato
  node [shape=ellipse fontname="Helvetica" fontsize=11 style=filled]
  THIS [label="scalability" fillcolor="#ffd700" fontsize=13 style="filled,bold"]
