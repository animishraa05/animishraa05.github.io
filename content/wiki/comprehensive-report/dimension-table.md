...
## Connections
- Built from: [[star-schema|Star Schema]] — dimension tables are a core component
- Builds into: [[fact-table|Fact Table]] — fact tables reference dimensions via foreign keys
