...
Auto-created stub for broken link `[[sectoring]]` — needs human content.
...
```dot
graph semantic_sectoring {
  layout=neato
  node [shape=ellipse fontname="Helvetica" fontsize=11 style=filled]
  THIS [label="sectoring" fillcolor="#ffd700" fontsize=13 style="filled,bold"]
