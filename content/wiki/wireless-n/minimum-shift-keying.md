...
```dot
digraph Minimum_Shift_Keying {
  rankdir=LR
  node [shape=box style=filled fillcolor="#f0f4ff" fontname="Helvetica"]
  A [label="Minimum Shift Keying\nInput"]
  B [label="Minimum Shift Keying\nCore Mechanism"]
  C [label="Minimum Shift Keying\nOutput"]
  A -> B [label="triggers"]
  B -> C [label="produces"]
}
```
...
```dot
graph semantic_Minimum_Shift_Keying {
  layout=neato
  node [shape=ellipse fontname="Helvetica" fontsize=11 style=filled]
  THIS [label="Minimum Shift Keying" fillcolor="#ffd700" fontsize=13 style="filled,bold"]
