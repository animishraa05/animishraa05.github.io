...
```dot
digraph modulation_techniques_compared {
  rankdir=LR
  node [shape=box style=filled fillcolor="#f0f4ff" fontname="Helvetica"]
  A [label="Modulation Technique\nInput"]
  B [label="Modulation Technique\nCore Mechanism"]
  C [label="Modulation Technique\nOutput"]
  A -> B [label="triggers"]
  B -> C [label="produces"]
}
```
...
```dot
graph semantic_modulation_techniques_compared {
  layout=neato
  node [shape=ellipse fontname="Helvetica" fontsize=11 style=filled]
  THIS [label="Modulation Technique" fillcolor="#ffd700" fontsize=13 style="filled,bold"]
