...
Auto-created stub for broken link `[[ejb-container]]` — needs human content.
...
```dot
digraph ejb-container {
  rankdir=LR
  node [shape=box style=filled fillcolor="#f0f4ff" fontname="Helvetica"]
  A [label="Stub: ejb-container"]
...
```dot
graph semantic_ejb-container {
  layout=neato
  node [shape=ellipse fontname="Helvetica" fontsize=11 style=filled]
  THIS [label="ejb container" fillcolor="#ffd700" fontsize=13 style="filled,bold"]
