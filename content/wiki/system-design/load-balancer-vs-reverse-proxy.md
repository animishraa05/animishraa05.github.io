...
```dot
digraph load_balancer_vs_reverse_proxy {
  rankdir=LR
  node [shape=box style=filled fillcolor="#f0f4ff" fontname="Helvetica"]
  A [label="Load Balancer Vs Rev\nInput"]
  B [label="Load Balancer Vs Rev\nCore Mechanism"]
  C [label="Load Balancer Vs Rev\nOutput"]
  A -> B [label="triggers"]
  B -> C [label="produces"]
}
```
...
```dot
graph semantic_load_balancer_vs_reverse_proxy {
  layout=neato
  node [shape=ellipse fontname="Helvetica" fontsize=11 style=filled]
  THIS [label="Load Balancer Vs Rev" fillcolor="#ffd700" fontsize=13 style="filled,bold"]
