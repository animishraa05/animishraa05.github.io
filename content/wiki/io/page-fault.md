...
```dot
graph semantic_Page_Fault {
  layout=neato
  node [shape=ellipse fontname="Helvetica" fontsize=11 style=filled]
  THIS [label="Page Fault" fillcolor="#ffd700" fontsize=13 style="filled,bold"]
...
- **Builds into:** [[demand-paging|Demand Paging]], [[wiki/io/thrashing|Thrashing]]
