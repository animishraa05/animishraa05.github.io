...
```dot
graph semantic_Virtual_Memory {
  layout=neato
  node [shape=ellipse fontname="Helvetica" fontsize=11 style=filled]
  THIS [label="Virtual Memory" fillcolor="#ffd700" fontsize=13 style="filled,bold"]
...
- **Built from:** [[wiki/io/paging|Paging]], [[demand-paging|Demand Paging]]
- **Builds into:** [[swap-space|Swap Space]], [[wiki/io/thrashing|Thrashing]]
