<img src='Pasted image 20260609121027.png'>![[md-notes_Pasted image 20260609121027.png]] <img>
...
1. Browse through the directories to find relevant topics
2. Each directory contains markdown files with detailed explanations
3. Use internal links (like `[[topic]]`) to navigate between related concepts
4. Add more directories as you expand your preparation materials

## 📝 Adding Content

As you add more directories and content:
- Keep file names descriptive and lowercase with hyphens (e.g., `docker-basics.md`)
- Use clear markdown formatting with headers and code blocks
- Link related concepts within the vault using `[[link]]` syntax
- Update this README to reflect new sections
