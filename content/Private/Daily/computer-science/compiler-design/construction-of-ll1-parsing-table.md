...
![LL(1) Parser](images_ll1-parser.jpg)
...
Trick - Above grammar is [[Private/Daily/computer-science/compiler-design/ambiguous-grammar|ambiguous grammar]]. So the grammar does not satisfy the essential conditions. So we can say that this grammar is not feasible for LL(1) Parser even without making the parse table.
