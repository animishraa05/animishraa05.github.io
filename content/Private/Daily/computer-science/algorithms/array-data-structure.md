...
2. [[selection-sort|Selection Sort]], Insertion Sort, [[binary-search|Binary Search]], QuickSort, MergeSort, CycleSort, and HeapSort
...
- Construct an array from its pair-sums
- Next Permutation
...
- Range sum query using [[sparse-table|Sparse Table]]
- Range Minimum Query
- Range LCM Queries
- [[merge-sort|Merge Sort]] Tree for Range Order Statistics
