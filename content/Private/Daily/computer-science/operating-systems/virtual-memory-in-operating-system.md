...
1. [[Private/Daily/computer-science/operating-systems/paging|Paging]]
2. Segmentation

### 1. Paging

[[Private/Daily/computer-science/operating-systems/paging|Paging]] divides memory into small fixed-size blocks called pages. When the computer runs out of RAM, pages that aren't currently in use are moved to the hard drive, into an area called a swap file. Here,
...
- Efficient Memory Management: Virtual memory also helps in better utilization of the physical memories through methods that include [[Private/Daily/computer-science/operating-systems/paging]] and segmentation.
...
- Supports Multiprogramming & Larger Programs : Virtual memory allows multiple processes to reside in memory at once by using demand [[Private/Daily/computer-science/operating-systems/paging]]. Even programs larger than physical memory can be executed efficiently.
...
| Data Access | Indirect (via [[Private/Daily/computer-science/operating-systems/paging]] and swapping) | Direct (CPU can access data directly) |
