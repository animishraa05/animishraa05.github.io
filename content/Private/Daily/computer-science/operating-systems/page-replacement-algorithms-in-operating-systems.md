...
In an operating system that uses [[Private/Daily/computer-science/operating-systems/paging]], a page replacement algorithm is needed when a page fault occurs and no free page frame is available. In this case, one of the existing pages in memory must be replaced with the new page.
...
![FIFO - Page Replacement](images_fifo-page-replacement.jpg)
...
![Optimal Page Replacement](images_optimal-page-replacement.jpg)
...
![Least Recently Used - Page Replacement](images_least-recently-used-page-replacement.jpg)
...
![Most Recently Used - Page Replacement](images_most-recently-used-page-replacement.jpg)
