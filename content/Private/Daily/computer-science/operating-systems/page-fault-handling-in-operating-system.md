...
![page-fault](images_page-fault.png)
...
- Demand [[Private/Daily/computer-science/operating-systems/paging|Paging]]: Accessing the page that is not currently loaded in the memory (RAM).
...
- [[Private/Daily/computer-science/operating-systems/thrashing|Thrashing]]: If occurrence of page fault is frequent then the system spends more time to handle it than executing the processes, and because of which overall performance also degrades.
