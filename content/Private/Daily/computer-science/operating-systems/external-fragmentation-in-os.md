...
![419337643](images_419337643.webp)

## How to Avoid External Fragmentation?

To avoid external fragmentation in an operating system:

- [[Private/Daily/computer-science/operating-systems/paging|Paging]]/Segmentation: [[Private/Daily/computer-science/operating-systems/paging|Paging]] allocates memory in fixed-size pages, avoiding external fragmentation. Segmentation uses variable-sized blocks but may still leave some gaps.
...
[[Private/Daily/computer-science/operating-systems/paging|Paging]] is a memory management technique that divides physical memory into fixed-size blocks called pages. It helps overcome external fragmentation and simplifies memory allocation.
