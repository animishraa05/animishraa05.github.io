...
Segmentation is a memory management technique where a process is divided into variable-sized chunks called segments. Unlike [[Private/Daily/computer-science/operating-systems/paging]], segmentation matches the user’s logical view of a program (functions, arrays, modules) to physical memory.
...
- User-Controlled Size: Segment size is defined by the user, unlike fixed page size in [[Private/Daily/computer-science/operating-systems/paging]].
...
- Complexity: Managing multiple variable-sized segments is harder than [[Private/Daily/computer-science/operating-systems/paging]].
