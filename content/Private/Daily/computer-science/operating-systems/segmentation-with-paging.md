...
Segmentation with Paging is a hybrid memory management technique that combines the advantages of both segmentation and [[Private/Daily/computer-science/operating-systems/paging]].

### How it Works

- A process is generally divided into four segments, namely - code, data, stack and heap.

![](images_segmentsofaprocess.png)
...
![](images_virtualaddresswithsegmentnoandpageno.png)
...
![](images_segmentedpaging.png)

Below is a complete workflow diagram of Segmented [[Private/Daily/computer-science/operating-systems/paging|Paging]]:

![Segmented_paging](images_segmented_paging.webp)

Advantages of Segmented [[Private/Daily/computer-science/operating-systems/paging|Paging]]

1. The page table size is reduced as pages are present only for data of segments, hence reducing the memory requirements.
2. Gives a programmers view along with the advantages of [[Private/Daily/computer-science/operating-systems/paging]].
3. Reduces external fragmentation in comparison with segmentation.

Disadvantages of Segmented [[Private/Daily/computer-science/operating-systems/paging|Paging]]
