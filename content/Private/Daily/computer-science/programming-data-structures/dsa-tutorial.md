...
# DSA Tutorial
DSA stands for Data Structures and Algorithms. Data structures manage how data is stored and accessed. Algorithms focus on processing this data. Examples of data structures are Array, Linked List, Tree and Heap, and examples of algorithms are [[binary-search|Binary Search]], [[quick-sort|Quick Sort]] and [[merge-sort|Merge Sort]].
...
- Advanced Topics : Trie, [[segment-tree|Segment Tree]], Red-Black Tree & Binary Indexed Tree
- Other Algorithms : [[bitwise-algorithms|Bitwise Algorithms]], Backtracking, Divide and Conquer, Branch and Bound, Geometric & Randomized
...
- Complexity Analysis : Order of Growth, [[asymptotic-analysis|Asymptotic Analysis]], Big-O, Theta, Big – Ω, Time Complexity, Space Complexity
...
- Medium Maths: Sum of Digits, Prime Testing, Armstrong Number
- Hard : Butterfly, Palindrome Number, Tower of Hanoi, Josephus Problem

### Array & String

- Theory : Array, String, Matrix
- Easy Array : Is Sorted, Reverse, Reverse in Groups, Rotate, Generate All Subarrays, Arrange by Sign, Stock with 1 Transaction. Leaders
...
- Medium Array : Majority Element, Majority Element II, Sorted subsequence of 3, Next Permutation, Kadane's Algorithm, Sum of all subarrays, Max Product Subarray
...
- Hard : Max Circular Subarray Sum, Next Smallest Palindrome, Lexicographic Rank, Text Justification, Set Matrix 0

### Searching

- Theory : Searching
- Linear Search : Largest, Second Largest, Local Min & Max
- [[binary-search|Binary Search]] : Insertion Position, Lower Bound, Upper Bound, Single Element, Missing Natural, Count Occurrences, 2D Search, Sorted & Rotated, Sorted & Rotated II, K Closest, Search in Almost Sorted, Peak, Peak in 2D, Range based Counts, Ternary Search, Kth Missing,
- Search on answer: Square Root, Nth Root, Check Power, Pick K, N trailing zeroes, Book Allocation, Koko Eating Banana, Aggressive Cows, Painter’s partition, Median in a Row-Wise Sorted, Kth Smallest, M bouquets, kth in Multiplication Table, Maximize Median, Min Time for Orders, Equalize Towers
...
- Partition & [[quick-sort|Quick Sort]] Based : [[quick-sort|Quick Sort]], Sort Binary, Zeroes to End, Sort Ternary
- Merge & [[merge-sort|Merge Sort]] Based : [[merge-sort|Merge Sort]], Union of 2 Sorted, Intersection of 2 Sorted, Merge Without Extra Space, Minimum Platforms, Inversion count, Surpasser Count
...
- Hashing for Frequency: Count Frequencies, Most Frequent, Consecutive Subsequence, Subarrays with distinct count, Anagrams
...
- Count Subarrays: Subarrays with k odds, Subarrays Less Than K, Substrings with all vowels, Number of Subarrays having sum less than K, Count Subarrays with K Equal Value Pairs, Count Strictly Increasing Subarrays
- Sliding Window with Hashing: Longest substring with distinct, Substring character replacement, Longest Substring with K Uniques, Substrings with k distinct, Smallest with all characters, Smallest distinct, Count Anagrams

### Prefix Sum

- Theory : Prefix Sum
- Prefix Sum: Prefix Sum Array, Prefix Sum on 2D, Range Queries, Equilibrium [[index|Index]], Mean of range, Split array, Largest Submatrix, Max sum rectangle
...
- Hard : N Queen Problem, Sudoku Solver, Word Break, Knight's Tour, Palindromic Partitions
...
- Theory : Deque
- Easy : Processing backspace characters, Rearrange Linked List to Alternate First and Last, Lexicographically largest permutation
- Medium : Reverse a Linked List in groups, Segregate even and odd nodes in a Linked List, Implement Stack and Queue using Deque, Nth term of given recurrence relation, Generate Bitonic Sequence
- Hard : Longest Subarray with Difference ≤ X, Max Subarray Length with K Increments, Min Deques to Sort Array, Sliding Window Maximum

### Binary Tree

- Theory : [[Private/Daily/computer-science/programming-data-structures/binary-tree|Binary Tree]], Inorder, Preorder, Postorder, Level Order
...
- Medium : Longest Bloodline Sum, Diameter, Boundary Traversal, Tree from Preorder and Inorder, Leaf at Same Level, Connect at Same Level, Nodes without siblings, Invert Tree, Flatten Tree, Max Diff Node & Ancestor
...
- Theory : [[Private/Daily/computer-science/programming-data-structures/binary-search-tree|Binary Search Tree]]
...
- Theory : Heap
- Easy : Check for Heap, [[heap-sort|Heap Sort]], kth Largest, K Largests, Height of a Heap
...
- [[topological-sorting|Topological Sorting]]: [[topological-sorting|Topological Sorting]], Course Schedule II, Alien Dictionary
...
- 1-D DP: Climbing Stairs, Frog Jump, House Robber, Coin Change, Possible Decodings, Best Time to Buy and Sell with Cooldown, Word Break
...
- SubSequence: Partition Subset, Subset Sum, Count of Subsets With Sum equal to target, Target Sum, 0/1 Knapsack, Coin Change II, Rod Cutting
...
- Stock: Stock Buy and Sell - Max one Transaction Allowed, Stock Buy and Sell – Max 2 Transactions Allowed, Stock Buy and Sell - At most k Transactions Allowed, Stock Buy and Sell - Multiple Transaction Allowed, Stock Buy and Sell with Transaction Fee
...
- Easy : LCM, Factors, Prime Factorization, Count Divisors, nCr, Euler's Totient
...
- Basic [[segment-tree|Segment Tree]] Queries: [[segment-tree|Segment Tree]], Min-Max Range Queries, Range LCM Queries, XOR of a given range
- [[segment-tree|Segment Tree]] with Updates: Lazy Propagation, Flipping Sign
- [[segment-tree|Segment Tree]] Applications: Build a [[segment-tree|segment tree]] for N-ary rooted tree, Maximum of all subarrays of size K using [[segment-tree|Segment Tree]]
