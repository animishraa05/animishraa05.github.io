...
- layer 1 physical device. connects more than one [[31_Ethernet|ethernet]] together to share the same medium, takes electrical signal from one place and sends it to every channel(broadcasts), doesnt matter who the recipent is, so it was obsolete kind of technology basically.
  -- was not efficent
...
- **Layer 6: Presentation Layer** - Responsible for data translation, encryption, and compression. It ensures that data from [[10_The_Application_Layer|the application layer]] is in a readable format for [[10_The_Application_Layer|the application layer]] of the destination system.
