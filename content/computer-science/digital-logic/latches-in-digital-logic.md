...
![SR latch using NAND gate](images/sr-latch-using-nand-gate.png)

The below logic diagram represents SR latch using NOR Gate.

![ SR latch using NOR Gate.](images/sr-latch-using-nor-gate.png)
...
![Case 1: S' = R' = 1 (S = R = 0) ](images/case-1-s-r-1-s-r-0.png)

- As S' = 0, the output of 1st NAND gate, Q = 1 (SET state).
- In second NAND gate, as Q and R' inputs are 1, Q'=0.

![Case 2: S' = 0, R' = 1 (S = 1, R = 0) ](images/case-2-s-0-r-1-s-1-r-0.png)
...
![Case 3: S' = 1, R' = 0 (S = 0, R = 1) ](images/case-3-s-1-r-0-s-0-r-1.png)
...
![Logic Diagram of Gated SR Latch](images/logic-diagram-of-gated-sr-latch.jpg)
...
![Logic Diagram of D Latch](images/logic-diagram-of-d-latch.jpg)
...
![Logic Diagram of Gated D Latch](images/logic-diagram-of-gated-d-latch.png)
...
![Logic-Diagram-of-JK-Latch](images/logic-diagram-of-jk-latch.webp)
...
![Logic-Diagram-of-T-Latch](images/logic-diagram-of-t-latch.webp)
