...
4. [[compiler-construction-tools|Compiler construction tools]]
5. [[symbol-table-in-compiler|Symbol Table in Compiler]]
...
2. FIRST and FOLLOW
3. [[classification-of-context-free-grammars|Classification of Context Free Grammars]](CFG)
4. [[ambiguous-grammar|Ambiguous Grammar]]
...
10. [[operator-grammar-and-precedence-parser|Operator grammar and precedence parser]]
...
- [[compiler-design-cd-for-gate-exam|Compiler Design (CD) for GATE Exam]]