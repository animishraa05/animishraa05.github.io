---
title: "Categories of End Users in DBMS"
topic: "dbms"
...
End users are basically those people whose jobs require access to the database for querying, updating, and generating reports. The database primarily exists for their use. End users in DBMS are the people who directly interact with the database to retrieve or update data. They are categorized based on how they use the database and their level of technical knowledge.

![categories_of_end_users](images/categories_of_end_users.webp)
...
3. Clerks who are working at the receiving end for shipping companies enter the package identified via barcodes and descriptive information through buttons to update a central database of received and in-transit packages.
