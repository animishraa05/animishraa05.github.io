...
![lazy-swapping](images/lazy-swapping.jpg)
...
- [[thrashing|Thrashing]]: Excessive swapping (when the system spends most of its time swapping pages rather than executing useful tasks) severely hampers performance.
