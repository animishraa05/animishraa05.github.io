...
![Disk Access Time and Disk Response Time](images/disk-access-time-and-disk-response-time.png)
...
![First Come First Serve](images/first-come-first-serve.jpg)
...
![Shortest Seek Time First](images/shortest-seek-time-first.jpg)
...
![SCAN Algorithm](images/scan-algorithm.jpg)
...
![Circular SCAN](images/circular-scan.jpg)
...
![LOOK Algorithm](images/look-algorithm.jpg)
