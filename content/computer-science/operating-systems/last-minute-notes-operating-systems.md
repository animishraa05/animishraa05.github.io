...
- The cause of external fragmentation is the condition in Fixed partitioning and Variable partitioning saying that entire process should be allocated in a contiguous memory location. Therefore [[paging|Paging]] is used.
...
Techniques to Handle [[thrashing|Thrashing]]
...
![Continuous-allocation](images/continuous-allocation.webp)
...
![Linked-Allocation](images/linked-allocation.webp)
...
![Indexed-Allocation](images/indexed-allocation.webp)
