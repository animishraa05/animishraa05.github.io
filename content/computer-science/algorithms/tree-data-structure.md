...
2. Applications
3. Properties of [[binary-tree|Binary Tree]]
4. Tyes of [[binary-tree|Binary Tree]]
5. Inorder Traversal
...
6. Deletion
7. More Problems on [[binary-search-tree|Binary Search Tree]]
...
1. [[Basics|Introduction]] to Red-Black Tree
...
2. Ternary Search Tree (Deletion)
3. Auto-complete feature using Ternary Search Tree
4. Longest word in ternary search tree

## n-ary or Generic Tree

1. Generic Trees(N-ary Trees)
2. Depth of an N-ary Tree
3. Children of a Node in an N-ary Tree
4. Find Siblings in an N-ary Tree
5. Mirror of n-ary Tree
6. Diameter of an N-ary Tree
7. Level Order Traversal of N-ary Tree
8. Sum of all elements of N-ary Tree
9. Serialize and Deserialize an N-ary Tree

## B Tree

1. [[Basics|Introduction]] of B-Tree
2. Insert Operation in B-Tree
3. Delete Operation in B-Tree
4. B-Tree Insert without aggressive splitting

## B+ Tree

1. [[introduction-of-b-tree|Introduction of B+ Tree]]
2. Insertion in a B+ tree
3. Deletion in B+ Tree

## Other types of Trees

- Ternary Tree:What is Ternary TreeCreate a Doubly Linked List from a Ternary Tree
- [[interval-tree|Interval Tree]]:Interval TreeInterval Tree using GNU Tree-based container
- 2-3-4 Tree:2-3-4 Tree2-3 Trees | (Search, Insert, and Deletion)

1. What is Ternary Tree
2. Create a Doubly Linked List from a Ternary Tree

1. [[interval-tree|Interval Tree]]
2. [[interval-tree|Interval Tree]] using GNU Tree-based container
